...
export const Guide: React.FC<Props> = (): JSX.Element => {
      ...
      <Grid container className={classes.Guide_container}>
        <Grid item xs={12}>
          ...
          <Typography variant="body1">
            ...
            large, blue drop zone. When a file is dragged over the drop zone, it
        ...
        <Grid item xs={12}>
          ...
          <Typography variant="body1">
            ...
            be listed in the drop down labelled &quot;Sheet Selection&quot;.
            Choose the sheet you wish to edit using this drop down. If your file
            only has one sheet, you still need to select it here before
            continuing.
          </Typography>
          <Typography variant="body1">
          ...
          <Typography variant="body1">
            ...
            Again, we do not keep copies of processed sheets, or any client data
            at all.
          </Typography>
        </Grid>
        ...
        <Grid item xs={12}>
          ...
          <Typography variant="body1">
            ...
            down, its data is read and the editor settings panels will be
          ...
          <Typography variant="body1">
            ...
            number. If you enter an invalid cell range, you can still process
          ...
          <Typography variant="body1">
            Under limit settings are used to define which cells will be treated
            as an under limit case and how to transform such cells. Required
            settings are the &quot;Trigger Character&quot; and &quot;Transform
            Function&quot; settings.
          </Typography>
          <Typography variant="body1">
            The &quot;Trigger Character&quot; setting allows you to input a
            character or line of text that matches the detection limit notation
            in your data cells. Most labs will use a &quot;&lt;&quot; character
            to denote that a value is less than a minimum detection limit, while
            others are known to use a &quot;&minus;&quot; character. In addtion
          ...
          <Typography variant="body1">
            To input your trigger character or text string, simply enter it into
            the setting input. This setting allows all standard punctuation and
            alpha characters without spaces.
          </Typography>
          <Typography variant="body1">
          ...
          <Typography variant="body1">
            Lastly, in the special case where your lab has included entires like
            &quot;null&quot;, &quot;void&quot;, &quot;zero&quot;, or other text
            values to represent a zero value, the &quot;Zero Trigger&quot;
            setting is included as an optional method to set these values to a
            true 0 number value. This setting will accept any alpha text value
            and is case&ndash;sensitive. Cell values equal this trigger value
            will be transformed to a 0 number value. This is an optional
            setting, and will still respect any specificed Scope Range settings
            applied.
          </Typography>
          ...
          <Typography variant="body1">
            ...
            as the Under Limit settings, so you can process over limits how you
          ...
          <Typography variant="body1">
            ...
            show any errors on your input settings. Once settings are valid, the
            &quot;Process&quot; button will enable and you can click it to
            process your sheet!
          </Typography>
          <Typography variant="body1">
            On the other hand, the &quot;Reset&quot; button will enable after
            you have started to input any settings at all. If you make too many
            mistakes, you can click it to reset the form back to its initial
            settings. However, if you have results from a previous process
            displayed below, hitting the reset button will also clear out those
            previous results, as only one result per sheet process are
            displayed.
          </Typography>
          <Typography variant="body1">
            If you have not exported your current result as a sheet, then you
            will lose that result upon reseting the settings. Transformed sheets
            will be lost, unless you exported the sheet for download. As we do
            not keep any client sheets or data, we cannot retreive any previous
            processed sheets.
          </Typography>
        </Grid>
        ...
        <Grid item xs={12}>
          ...
          <Typography variant="body1">
            ...
            section will open below the Editor Settings. In this section, any
            &quot;Under Limit&quot;, &quot;Over Limit&quot; or &quot;Zero
            Trigger&quot; case results that were found will be displayed. If no
          ...
          <Typography variant="body1">
            ...
            the &quot;Inspect&quot; button. This will open a side bar list of
          ...
          <Typography variant="body1">
            ...
            &quot;View Preview&quot; button. A preview of your whole sheet will
            be generated and you can scroll around to view each transformation
            as part of the whole sheet. Note that if a Scope Range was set, the
        ...
        <Grid item xs={12}>
          ...
          <Typography variant="body1">
            ...
            like to receive. From here, the &quot;Secure Payment&quot; form will
            open and you can complete the purchase process. If for some reason
          ...
          <Typography variant="body1">
            Currenly, you can export the sheet as a new Microsoft Excel workbook
            file in either <strong>Excel 2007&#43; XML Format .xlsx</strong> and
            &nbsp;
          ...
          <Typography variant="body1">
            ...
            if you&apos;d like to receive a receipt, and accept our Terms &amp;
